...
public class ManifestHeader {
    ...
    throws IllegalArgumentException {
        ...
        final List dirsList = new ArrayList();
        ...
        ManifestHeader.NameValuePair[] dirs =
            (NameValuePair[]) dirsList.toArray(new ManifestHeader.NameValuePair[dirsList.size()]);

        // Create attribute array.
        ManifestHeader.NameValuePair[] attrs =
            (NameValuePair[]) attrsList.toArray(new ManifestHeader.NameValuePair[attrsList.size()]);
